...
To facilitate the review process, we have provided the core functional structure of the project:
...
* **`source/isaaclab_tasks/`**: Defines the task environment structures and configuration files for our benchmarks.
* **`assets/`**: Houses the URDF/USD and mesh files for the humanoid robots, ensuring the simulation setup is transparent and verifiable.
* **`source/isaaclab*`**: Includes the necessary framework wrappers and dependency modules to support the repository's architecture.
