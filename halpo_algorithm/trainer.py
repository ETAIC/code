...
class LocalHALPOTrainer:
    def __init__(
        ...
        self.optimizer = SGD(self.actor.parameters(), lr=lr, maximize=True)
        self.device = device
        ...
        self.updater = HalpoUpdater(
            ...
            max_grad_norm=0.0 if self.max_grad_norm is None else float(self.max_grad_norm),
        )
    ...
    def collect_rollout(self):
        ...
        for t in range(self.buffer.T):
            ...
            done = (terminated_dict["robot_0"] | truncated_dict["robot_0"]) | (terminated_dict["robot_1"] | truncated_dict["robot_1"])
        ...
        self.episode_metrics = {
            ...
            'epoch_return': avg_episode_return,
