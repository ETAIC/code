...
def project_and_step(
    ...
    if mechanism_monitor is not None:
        ...
        metrics = mechanism_monitor.compute_metrics(
            ...
            d_star=d_star,
            V_t_mean=current_V_theta,
            delta_V_mean=delta_V_theta_simple,
    ...
    metrics = {
        "halpo/lyapunov_value_mean": float(current_V_theta),
        "halpo/lyapunov_delta_mean": float(delta_V_theta_approx),
